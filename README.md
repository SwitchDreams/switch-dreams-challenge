...
Faaala meu bom, tudo certo? Hoje iremos propor um desafio para avaliar suas habilidades com o framework Ruby on Rails, sendo isso parte do processo seletivo para vaga de desenvolvedor backend e frontend aqui na Switch Dreams.
...
Para iniciar o desafio você deverá fazer um fork desse repositório e iniciar o seu projeto ruby a partir dele. Edite esse readme com as informações necessárias para nos ajudar a rodar o seu projeto localmente (Se fizer um deployzão a gente gosta!). Ao final do projeto, envie o link do seu **fork**.

Para padronizar o desafio você deve usar o Postgres como banco de dados e a versão do Rails pode ser a 5.x ou 6.x com preferência para a 6. Sugerimos também que utilize a versão 2.7.x do ruby, para que você possa usar as features mais novas da linguagem.
